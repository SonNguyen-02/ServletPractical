...
<nav class="sidebar sidebar-offcanvas custom-scroll" id="sidebar">
    <ul class="nav custom-scroll">
        ...
        <li class="nav-item nav-item-hover">
            <a class="nav-link" href="${pageContext.request.contextPath}/practical3/dashboard">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Dashboard</span>
            </a>
        </li>
        <li class="nav-item nav-item-hover">
            <a class="nav-link" href="${pageContext.request.contextPath}/practical3/category">
                <i class="mdi mdi-format-list-bulleted-type menu-icon"></i>
                <span class="menu-title">Category</span>
            </a>
        </li>
        <li class="nav-item nav-item-hover">
            <a class="nav-link" href="${pageContext.request.contextPath}/practical3/product">
                <i class="mdi mdi-nintendo-switch menu-icon"></i>
